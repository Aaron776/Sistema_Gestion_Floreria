...
try {
    // Traer cliente
    $sql = $conexion->prepare("SELECT  id_usuario as id_cliente,nombre,email FROM usuarios WHERE rol='cliente'");
    $sql->execute();
    $clientes = $sql->fetchAll(PDO::FETCH_OBJ);

    // Traer lisatd de productos en estado activo
...
<style>
    /* ===== CONTENEDOR ===== */
    /* Centra la tarjeta y aplica background decorativo del body original */
    .create-wrapper {
        display: flex;
        align-items: center;
...
<div class="create-wrapper">
    <div class="create-container">
        <div class="create-header">
            ...
            <h1>Nuevo pedido</h1>
            <p>Registra un nuevo pedido para tu cliente</p>
        ...
        <form id="createOrderForm" action="../controladores/vendedor/registrar_pedido.php" method="POST" novalidate>
                ...
                <div class="input-wrapper">
                    ...
                    <select id="cliente" name="cliente" required>
                        ...
                        <?php foreach ($clientes as $item): ?>
                            <option value="<?php echo $item->id_cliente; ?>"><?php echo $item->nombre . '-' . $item->email; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
                ...
                <div class="input-wrapper">
                    ...
                    <select id="producto" name="producto" required>
                        ...
                        <?php foreach ($productos as $item): ?>
                            <option value="<?php echo $item->id_producto; ?>" data-precio="<?php echo $item->precio; ?>" data-stock="<?php echo $item->stock; ?>"><?php echo $item->nombre; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="number" id="cantidad" name="cantidad" placeholder="1" min="1" max="1" value="1" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="number" id="precioUnitario" name="precio_unitario" placeholder="0.00" step="0.01" min="0" readonly required>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="text" id="direccion" name="direccion_entrega" placeholder="Calle, número, ciudad, código postal" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <textarea id="mensaje" name="mensaje_tarjeta" placeholder="Instrucciones especiales, mensaje para el cliente, horario de entrega..."></textarea>
                </div>
            </div>
            ...
            <div class="total-display">
                ...
                <span class="total-amount"><i class="fas fa-dollar-sign"></i> <input type="number" id="totalAmount" name="total" step="0.01" min="0" value="0.00" readonly></span>
            </div>
                ...
                <div class="form-group toggle-group">
                    ...
                    <div class="input-wrapper toggle-wrapper">
                        ...
                        <label class="toggle-label">
                            ...
                            <input type="checkbox" id="pagado_ahora" name="pagado_ahora" value="1" checked>
            ...
            <div class="form-group" id="referenciaGroup" style="display:none;">
                ...
                <div class="input-wrapper">
                    <i class="fas fa-hashtag"></i>
                    <input type="text" id="referencia" name="referencia" placeholder="Últimos 4 dígitos, ID de transacción o folio">
                </div>
...
<script>
    ...
    // ===== SELECCIONAR PRODUCTO → precio + max cantidad + total =====
    ...
    // ===== MOSTRAR/OCULTAR REFERENCIA SEGÚN MÉTODO DE PAGO =====
