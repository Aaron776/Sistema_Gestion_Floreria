...
try {
    ...
    $sql=$conexion->prepare("SELECT id_categoria,nombre FROM categorias");
    $sql->execute();
...
?>
  ...
  <div class="create-container">
    ...
    <form id="createProductForm" action="../controladores/admin/agregar_producto.php" method="post" enctype="multipart/form-data">
      <input type="hidden" name="csrf_token" value="<?=$_SESSION['csrf_token']?>">
      <div class="form-group">
        <label for="name">Nombre del producto <span class="required">*</span></label>
        <div class="input-wrapper">
          <i class="fas fa-tag"></i>
          <input type="text" id="name" name="nombre" placeholder="Ej: Ramo de Rosas Rojas" required>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="input-wrapper">
          ...
          <textarea id="description" name="descripcion" placeholder="Describe el producto, sus características y usos..." required></textarea>
        </div>
      </div>
      ...
      <div class="form-row">
        <div class="form-group">
          ...
          <div class="input-wrapper">
            ...
            <input type="number" name="precio" id="price" placeholder="0.00" step="0.01" min="0" required>
          </div>
        </div>
      ...
      <!-- Imagen -->
      <div class="form-group">
        <label for="image">Imagen del producto <span class="required">*</span></label>
        <div class="image-upload-area" id="imageUploadArea">
          <div class="upload-icon">
            <i class="fas fa-cloud-upload-alt"></i>
          </div>
          <div class="upload-text">
            Arrastra y suelta tu imagen aquí o <strong>selecciona un archivo</strong>
          </div>
    ...
    imageInput.addEventListener('change', function(e) {
      ...
      if (file) {
        ...
        reader.onload = function(e) {
          ...
          // Remover error de imagen si existe
