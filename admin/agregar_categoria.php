...
<div class="create-container">
    <div class="create-header">
        <a href="gestion_categorias.php" class="back-link">
        ...
        <p>Agrega una nueva categoría para organizar tus productos</p>
    ...
    <form id="createCategoryForm" action="../controladores/admin/agregar_categoria.php" method="post">
        ...
        <div class="form-group">
            ...
            <div class="input-wrapper">
                <i class="fas fa-tag"></i>
                <input type="text" id="name" name="nombre" placeholder="Ej: Rosas, Arreglos, Follaje..." required>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="input-wrapper">
                ...
                <textarea id="description" name="descripcion" placeholder="Describe brevemente esta categoría..." required></textarea>
            </div>
        </div>
